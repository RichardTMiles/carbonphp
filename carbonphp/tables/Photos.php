...
use CarbonPHP\Tables\Traits\Photos_Columns;
...
class Photos extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::PHOTO_ID => Carbons::ENTITY_PK,
        self::PARENT_ID => Carbons::ENTITY_PK,
    ...
    **/
    public const PDO_VALIDATION = [
        self::PARENT_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'photos_entity_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::PHOTO_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'entity_photos_entity_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::USER_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'photos_entity_user_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::PHOTO_PATH => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '225', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::PHOTO_DESCRIPTION => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::PARENT_ID => [
     *                  [self::class => 'disallowPublicAccess', self::PARENT_ID]
     *              ],
     *              self::PHOTO_ID => [
     *                  [self::class => 'disallowPublicAccess', self::PHOTO_ID]
     *              ],
     *              self::USER_ID => [
     *                  [self::class => 'disallowPublicAccess', self::USER_ID]
     *              ],
     *              self::PHOTO_PATH => [
     *                  [self::class => 'disallowPublicAccess', self::PHOTO_PATH]
     *              ],
     *              self::PHOTO_DESCRIPTION => [
     *                  [self::class => 'disallowPublicAccess', self::PHOTO_DESCRIPTION]
     *              ],
     *          ],    
