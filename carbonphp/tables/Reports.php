...
use CarbonPHP\Tables\Traits\Reports_Columns;
...
class Reports extends Rest implements iRestNoPrimaryKey
{
    ...
    **/
     ...
     *              ],
     *              self::LOG_LEVEL => [
     *                  [self::class => 'disallowPublicAccess', self::LOG_LEVEL]
     *              ],
     *              self::REPORT => [
     *                  [self::class => 'disallowPublicAccess', self::REPORT]
     *              ],
     *              self::DATE => [
     *                  [self::class => 'disallowPublicAccess', self::DATE]
     *              ],
     *              self::CALL_TRACE => [
     *                  [self::class => 'disallowPublicAccess', self::CALL_TRACE]
     *              ],
     *          ],    
