...
use CarbonPHP\Tables\Traits\User_Followers_Columns;
...
class User_Followers extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::FOLLOWER_TABLE_ID => Carbons::ENTITY_PK,
        self::FOLLOWS_USER_ID => Carbons::ENTITY_PK,
    ...
    **/ 
    public const COLUMNS = [
        self::FOLLOWER_TABLE_ID => 'follower_table_id',
        self::FOLLOWS_USER_ID => 'follows_user_id',
    ...
    **/
    public const PDO_VALIDATION = [
        self::FOLLOWER_TABLE_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_user_followers_carbons_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::FOLLOWS_USER_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'followers_entity_entity_follows_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::USER_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'followers_entity_followers_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
    ];
    ...
    **/
     ...
     *                  [self::class => 'disallowPublicAccess', self::class],
     *              ],
     *              self::FOLLOWER_TABLE_ID => [
     *                  [self::class => 'disallowPublicAccess', self::FOLLOWER_TABLE_ID]
     *              ],
     *              self::FOLLOWS_USER_ID => [
     *                  [self::class => 'disallowPublicAccess', self::FOLLOWS_USER_ID]
     *              ],
     *              self::USER_ID => [
