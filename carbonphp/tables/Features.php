...
use CarbonPHP\Tables\Traits\Features_Columns;
 ...
 *  static method.
 */
class Features extends Rest implements iRestSinglePrimaryKey
{
    use Features_Columns;
    
    public const CLASS_NAME = 'Features';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::FEATURE_ENTITY_ID => Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_features. 
    ...
    **/ 
    public const COLUMNS = [
        ...
        self::FEATURE_CREATION_DATE => 'feature_creation_date',
    ];
    ...
    **/
    public const PDO_VALIDATION = [
        self::FEATURE_ENTITY_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_features_carbons_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::FEATURE_CODE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '30', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::FEATURE_CREATION_DATE => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => self::CURRENT_TIMESTAMP ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::FEATURE_CODE => [
     *                  [self::class => 'disallowPublicAccess', self::FEATURE_CODE]
     *              ],
     *              self::FEATURE_CREATION_DATE => [
     *                  [self::class => 'disallowPublicAccess', self::FEATURE_CREATION_DATE]
     *              ],
     *          ],    
