...
class Locations extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_ID => Carbons::ENTITY_PK,
    ];
    ...
    **/
    public const PDO_VALIDATION = [
        self::ENTITY_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'entity_location_entity_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::LATITUDE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '225', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::LONGITUDE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '225', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::STREET => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '225', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::CITY => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '40', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::STATE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '10', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::ELEVATION => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '40', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::ZIP => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::LATITUDE => [
     *                  [self::class => 'disallowPublicAccess', self::LATITUDE]
     *              ],
     *              self::LONGITUDE => [
     *                  [self::class => 'disallowPublicAccess', self::LONGITUDE]
     *              ],
     *              self::STREET => [
     *                  [self::class => 'disallowPublicAccess', self::STREET]
     *              ],
     *              self::CITY => [
     *                  [self::class => 'disallowPublicAccess', self::CITY]
     *              ],
     *              self::STATE => [
     *                  [self::class => 'disallowPublicAccess', self::STATE]
     *              ],
     *              self::ELEVATION => [
     *                  [self::class => 'disallowPublicAccess', self::ELEVATION]
     *              ],
     *              self::ZIP => [
     *                  [self::class => 'disallowPublicAccess', self::ZIP]
     *              ],
     *          ],    
