...
use CarbonPHP\Tables\Traits\Groups_Columns;
...
class Groups extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        ...
        self::CREATED_BY => Carbons::ENTITY_PK,
    ];
    ...
    **/
    public const PDO_VALIDATION = [
        self::GROUP_NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::ENTITY_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_feature_groups_carbons_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::CREATED_BY => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_feature_groups_carbons_entity_pk_fk_2', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
