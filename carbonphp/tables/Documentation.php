...
use CarbonPHP\Tables\Traits\Documentation_Columns;
 ...
 *  static method.
 */
class Documentation extends Rest implements iRestNoPrimaryKey
{
    use Documentation_Columns;
    
    public const CLASS_NAME = 'Documentation';
    
    public const CLASS_NAMESPACE = 'CarbonPHP\Tables\\';
    
    public const TABLE_NAME = 'carbon_documentation';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_documentation. 
    ...
    **/
    public const DOCUMENTATION_URI = 'carbon_documentation.documentation_uri'; 

    public const DOCUMENTATION_DATA = 'carbon_documentation.documentation_data'; 

    public const DOCUMENTATION_VERSION = 'carbon_documentation.documentation_version'; 

    public const DOCUMENTATION_ACTIVE = 'carbon_documentation.documentation_active'; 
    ...
    **/ 
    public const COLUMNS = [
        ...
        self::DOCUMENTATION_ACTIVE => 'documentation_active',
    ];
    ...
    **/
    public const PDO_VALIDATION = [
        self::DOCUMENTATION_URI => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::DOCUMENTATION_DATA => [ self::MYSQL_TYPE => 'longblob', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::DOCUMENTATION_VERSION => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '40', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::DOCUMENTATION_ACTIVE => [ self::MYSQL_TYPE => 'tinyint', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
    ];
    ...
    **/
     ...
     *                  [self::class => 'disallowPublicAccess', self::DOCUMENTATION_URI]
     *              ],
     *              self::DOCUMENTATION_DATA => [
     *                  [self::class => 'disallowPublicAccess', self::DOCUMENTATION_DATA]
     *              ],
     *              self::DOCUMENTATION_VERSION => [
     *                  [self::class => 'disallowPublicAccess', self::DOCUMENTATION_VERSION]
     *              ],
     *              self::DOCUMENTATION_ACTIVE => [
     *                  [self::class => 'disallowPublicAccess', self::DOCUMENTATION_ACTIVE]
     *              ],
     *          ],    
