...
use CarbonPHP\Tables\Traits\Group_References_Columns;
...
class Group_References extends Rest implements iRestNoPrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        ...
        self::ALLOWED_TO_GRANT_GROUP_ID => Carbons::ENTITY_PK,
    ];
    ...
    **/ 
    public const COLUMNS = [
        ...
        self::ALLOWED_TO_GRANT_GROUP_ID => 'allowed_to_grant_group_id',
    ];
    ...
    **/
     ...
     *              ],
     *              self::ALLOWED_TO_GRANT_GROUP_ID => [
     *                  [self::class => 'disallowPublicAccess', self::ALLOWED_TO_GRANT_GROUP_ID]
     *              ],
     *          ],    
