...
class Carbons extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_FK => Carbons::ENTITY_PK,
    ];
    ...
    public const EXTERNAL_TABLE_CONSTRAINTS = [
        ...
        Feature_Group_References::GROUP_ENTITY_ID => self::ENTITY_PK,
        Feature_Group_References::FEATURE_ENTITY_ID => self::ENTITY_PK,
        Features::FEATURE_ENTITY_ID => self::ENTITY_PK,
        Group_References::GROUP_ID => self::ENTITY_PK,
        Group_References::ALLOWED_TO_GRANT_GROUP_ID => self::ENTITY_PK,
        Groups::ENTITY_ID => self::ENTITY_PK,
        Groups::CREATED_BY => self::ENTITY_PK,
        Location_References::ENTITY_REFERENCE => self::ENTITY_PK,
        Location_References::LOCATION_REFERENCE => self::ENTITY_PK,
        Locations::ENTITY_ID => self::ENTITY_PK,
        Photos::PHOTO_ID => self::ENTITY_PK,
        Photos::PARENT_ID => self::ENTITY_PK,
        Photos::USER_ID => self::ENTITY_PK,
        User_Followers::FOLLOWER_TABLE_ID => self::ENTITY_PK,
        User_Followers::FOLLOWS_USER_ID => self::ENTITY_PK,
        User_Followers::USER_ID => self::ENTITY_PK,
        User_Groups::GROUP_ID => self::ENTITY_PK,
        User_Groups::USER_ID => self::ENTITY_PK,
        User_Messages::FROM_USER_ID => self::ENTITY_PK,
        User_Messages::MESSAGE_ID => self::ENTITY_PK,
        User_Messages::TO_USER_ID => self::ENTITY_PK,
