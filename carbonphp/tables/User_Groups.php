...
use CarbonPHP\Tables\Traits\User_Groups_Columns;
 ...
 *  static method.
 */
class User_Groups extends Rest implements iRestNoPrimaryKey
{
    use User_Groups_Columns;
    
    public const CLASS_NAME = 'User_Groups';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::GROUP_ID => Carbons::ENTITY_PK,
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_user_groups. 
    ...
    **/
    public const PDO_VALIDATION = [
        self::GROUP_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_user_groups_carbons_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::USER_ID => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_user_groups_carbons_entity_pk_fk_2', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
    ];
