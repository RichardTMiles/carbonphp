...
use CarbonPHP\Tables\Traits\Location_References_Columns;
 ...
 *  static method.
 */
class Location_References extends Rest implements iRestNoPrimaryKey
{
    use Location_References_Columns;
    
    public const CLASS_NAME = 'Location_References';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_REFERENCE => Carbons::ENTITY_PK,
        self::LOCATION_REFERENCE => Carbons::ENTITY_PK,
    ];
    ...
    **/
    public const PDO_VALIDATION = [
        self::ENTITY_REFERENCE => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_location_references_carbons_entity_pk_fk', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::LOCATION_REFERENCE => [ self::MYSQL_TYPE => 'binary', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [Carbons::ENTITY_PK => [ self::CONSTRAINT_NAME => 'carbon_location_references_carbons_entity_pk_fk_2', self::UPDATE_RULE => 'CASCADE', self::DELETE_RULE => 'CASCADE'],], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::LOCATION_TIME => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => self::CURRENT_TIMESTAMP ],
    ];
    ...
    **/
     ...
     *                  [self::class => 'disallowPublicAccess', self::ENTITY_REFERENCE]
     *              ],
     *              self::LOCATION_REFERENCE => [
     *                  [self::class => 'disallowPublicAccess', self::LOCATION_REFERENCE]
     *              ],
     *              self::LOCATION_TIME => [
     *                  [self::class => 'disallowPublicAccess', self::LOCATION_TIME]
     *              ],
     *          ],    
